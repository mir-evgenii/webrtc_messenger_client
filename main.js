...
var app = new Vue({
  ...
  data: {
    ...
    widthMsgList: 9,
    isMobile:false,
    updateInterval:5000, // message update interval 5 sec
    boxWebrtcConnection:null, // permission from user to connect webrtc
    connectedfriendKey:null // key user to connect webrtc
  },
  ...
  async created() {
    ...
    if (getOnline()) { // update messages from -> getOnline() - api.js
